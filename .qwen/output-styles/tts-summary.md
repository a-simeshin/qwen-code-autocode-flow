...
```bash
uv run .qwen/hooks/utils/tts/elevenlabs_tts.py "YOUR_MESSAGE_TO_DAN"
```
...
```bash
uv run .qwen/hooks/utils/tts/elevenlabs_tts.py "Dan, I've created three new output styles to customize how you receive information."
```
