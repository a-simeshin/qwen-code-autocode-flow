...
Usage (Stop hook - finds newest file in directory):
  uv run --script validate_plan.py --directory specs --extension .md --team-dir .qwen/agents/team

Usage (direct call - specific file):
  uv run --script validate_plan.py --file specs/my-plan.md --team-dir .qwen/agents/team
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--team-dir', type=str, default='.qwen/agents/team',
        help='Directory with team agent .md files (default: .qwen/agents/team)'
    )
