...
8. Define Team Members - Use `ORCHESTRATION_PROMPT` (if provided) to guide team composition. Identify from `.qwen/agents/team/*.md` or use `general-purpose`. Include a test-builder member. Document in plan.
